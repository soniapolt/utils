function [RMAOV33] = RMAOV33(X,alpha, factnames)
...
%                                 \          \        \         
%                    
%   Syntax: function [RMAOV33] = RMAOV33(X,alpha, varnames) 
%      
%     Inputs:
...
%     if eval(['P' num2str(n) '>= alpha;']); % if P1 >= alpha;
%         eval(['ds' num2str(n) '= '' n.s.'' ;']) 
%     else
%         eval(['ds' num2str(n) '= '' S'' ;']) 
%     end;
    
    if  eval(['P' num2str(n) '< .001;']);   eval(['ds' num2str(n) '= ''***'' ;'])         
    elseif eval(['P' num2str(n) '< .01;']); eval(['ds' num2str(n) '= ''**'' ;'])         
    elseif eval(['P' num2str(n) '< .05;']); eval(['ds' num2str(n) '= ''*'' ;'])          
