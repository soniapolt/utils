function [modelfun, model, metric, resampling] = init_intempCSSn(expN,stimSize,hem,ppd)
...
% additionally, we will fit 4 weights that scale the stimulus image:
%   'wNose','wMouth','wSkin','wEyes'
...
load('tmpMasks.mat'); masks(4) = []; % do not use the hair mask
for m = 1:length(masks)
    msk = masks{m};
    % masks are condition-agnostic
